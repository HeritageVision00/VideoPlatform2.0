...
export class ROIComponent implements OnInit {
  ...
  relations: any = [];
  algos: any = [
    {activated:false},{activated:false},{activated:false},{activated:false},{activated:false},{activated:false},{activated:false},{activated:false},{activated:false},{activated:false},{activated:false},{activated:false},{activated:false},{activated:false},{activated:false},{activated:false},{activated:false},{activated:false},{activated:false},{activated:false},{activated:false},{activated:false},{activated:false},{activated:false},{activated:false},{activated:false},{activated:false},{activated:false},{activated:false},{activated:false},{activated:false},{activated:false},{activated:false},{activated:false},{activated:false},{activated:false}, { activated: false }, { activated: false }, { activated: false }, { activated: false }, { activated: false }, { activated: false }, { activated: false }, { activated: false }, { activated: false }, { activated: false }, { activated: false }, { activated: false }, { activated: false }, { activated: false }, { activated: false }, { activated: false }, { activated: false }, { activated: false }, { activated: false }, { activated: false }, { activated: false }, { activated: false }, { activated: false }, { activated: false }, { activated: false }, { activated: false }, { activated: false }, { activated: false },{ activated: false }, { activated: false }, { activated: false }, { activated: false }, { activated: false }, { activated: false }, { activated: false }, { activated: false }, { activated: false }, { activated: false }, { activated: false }, { activated: false }, { activated: false }, { activated: false }, { activated: false }, { activated: false }, { activated: false }, { activated: false }, { activated: false }, { activated: false }, { activated: false }, { activated: false },{ activated: false }, { activated: false },
  ];
  colour: string = '';
  fill: string ='';
  parking:any={};
  ...
  scale(){
    for(let u = 0; u < this.polygons.length; u++){
      for(let l = 0; l < this.polygons[u].length - 1; l++){
        //these parameters is to scalate it according to RoI resolution
        this.polygons[u][l]['x'] =   
           this.polygons[u][l]['x']*this.width/this.previousWidth;
        this.polygons[u][l]['y'] =
           this.polygons[u][l]['y']*this.height/this.previousHeight;
      }
    }
    // scaling for perimeter
    for(let i = 0; i < this.perimeter.length; i++){      
       this.perimeter[i]['x'] = this.perimeter[i]['x'] *
           this.width/this.previousWidth;
       this.perimeter[i]['y'] = this.perimeter[i]['y'] *
