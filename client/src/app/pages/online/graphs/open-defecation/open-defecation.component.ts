...
@Component({
  selector: 'ngx-open-defecation',
  templateUrl: './open-defecation.component.html',
  styleUrls: ['./open-defecation.component.scss']
})
export class OpenDefecationComponent implements OnInit {
