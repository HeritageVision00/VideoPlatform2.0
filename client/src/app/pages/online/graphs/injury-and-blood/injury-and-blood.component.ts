...
@Component({
  selector: 'ngx-injury-and-blood',
  templateUrl: './injury-and-blood.component.html',
  styleUrls: ['./injury-and-blood.component.scss']
})
export class InjuryAndBloodComponent implements OnInit {
