...
@Component({
  selector: 'ngx-women-violence',
  templateUrl: './women-violence.component.html',
  styleUrls: ['./women-violence.component.scss']
})
export class WomenViolenceComponent implements OnInit {
