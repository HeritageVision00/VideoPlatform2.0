...
@Component({
  selector: 'ngx-module-defect',
  templateUrl: './module-defect.component.html',
  styleUrls: ['./module-defect.component.scss']
})
export class ModuleDefectComponent implements  OnInit, OnDestroy {
  ...
  ngOnInit(): void {
    ...
    this.serv.module(this.camera, l).subscribe(
      (res) => {
        this.module = res["data"];
        for (var m of this.module.raw) {
          ...
          m["clip_path"] =
            ...
            "/" +
            m["clip_path"];
            m['videoClip']  = this.sanitizer.bypassSecurityTrustUrl(api + '/pictures/' + this.now_user['id_account'] + '/' + m['id_branch'] + '/module/' + m['cam_id'] + '/' + m['movie']);
        ...
        this.source = this.module.raw.slice().sort((a, b) => +new Date(b.time) - +new Date(a.time));

        let labels = [];
        for (var o of Object.keys(this.module.over)) {
          o = o + ":00:00";
        ...
        this.themeSubscription = this.theme.getJsTheme().subscribe((config) => {
          ...
          this.dataL = {
            ...
            datasets: [
              {
                label: "Modules defected Over Time",
                backgroundColor: NbColorHelper.hexToRgbA(colors.primary, 0.3),
                data: Object.values(this.module.over),
