...
@Component({
  selector: "ngx-smoking",
  templateUrl: "./smoking.component.html",
  styleUrls: ["./smoking.component.scss"],
})
export class SmokingComponent implements OnInit, OnDestroy {
  ...
  ngOnInit(): void {
    ...
    this.serv.smoking(this.camera, l).subscribe(
      (res) => {
        this.smoking = res["data"];
        for (var m of this.smoking.raw) {
          ...
          m['videoClip']  = this.sanitizer.bypassSecurityTrustUrl(api + '/pictures/' + this.now_user['id_account'] + '/' + m['id_branch'] + '/smoking/' + m['cam_id'] + '/' + m['movie']);
          m["clip_path"] =
            api +
            "/pictures/" +
            this.now_user["id_account"] +
            ...
            datasets: [
              {
                ...
                data: Object.values(this.smoking.over),
