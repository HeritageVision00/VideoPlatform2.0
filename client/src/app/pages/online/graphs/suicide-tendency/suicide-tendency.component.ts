...
@Component({
  selector: 'ngx-suicide-tendency',
  templateUrl: './suicide-tendency.component.html',
  styleUrls: ['./suicide-tendency.component.scss']
})
export class SuicideTendencyComponent implements OnInit {
