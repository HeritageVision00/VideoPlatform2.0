...
@Component({
  selector: 'ngx-stranded-girl',
  templateUrl: './stranded-girl.component.html',
  styleUrls: ['./stranded-girl.component.scss']
})
export class StrandedGirlComponent implements OnInit {
