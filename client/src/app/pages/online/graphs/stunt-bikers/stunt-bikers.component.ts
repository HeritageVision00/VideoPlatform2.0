...
@Component({
  selector: 'ngx-stunt-bikers',
  templateUrl: './stunt-bikers.component.html',
  styleUrls: ['./stunt-bikers.component.scss']
})
export class StuntBikersComponent implements OnInit {
