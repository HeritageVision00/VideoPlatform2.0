...
@Component({
  selector: 'ngx-flashing',
  templateUrl: './flashing.component.html',
  styleUrls: ['./flashing.component.scss']
})
export class FlashingComponent implements OnInit , OnDestroy {
  ...
  ngOnInit(): void {
    ...
    this.serv.FlashingNudity(this.camera, l).subscribe(
      (res) => {
        this.compData = res["data"];
        for (var m of this.compData.raw) {
          const path = `${api}/pictures/${this.now_user["id_account"]}/${m['id_branch']}/${this.compData.folder}/${m['cam_id']}/`
        ...
        let labels = [];
        for (var o of Object.keys(this.compData.over)) {
          o = o + ":00:00";
        ...
        this.themeSubscription = this.theme.getJsTheme().subscribe((config) => {
          ...
          this.dataL = {
            ...
            datasets: [
              {
                label: "Traffic Signals defected Over Time",
                backgroundColor: NbColorHelper.hexToRgbA(colors.primary, 0.3),
                data: Object.values(this.compData.over),
