...
@Component({
  selector: 'ngx-freq-visitor',
  templateUrl: './freq-visitor.component.html',
  styleUrls: ['./freq-visitor.component.scss']
})
export class FreqVisitorComponent implements OnInit  {
