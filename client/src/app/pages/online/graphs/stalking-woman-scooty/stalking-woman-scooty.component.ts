...
@Component({
  selector: 'ngx-stalking-woman-scooty',
  templateUrl: './stalking-woman-scooty.component.html',
  styleUrls: ['./stalking-woman-scooty.component.scss']
})
export class StalkingWomanScootyComponent implements OnInit {
