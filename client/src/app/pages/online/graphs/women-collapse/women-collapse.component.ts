...
@Component({
  selector: 'ngx-women-collapse',
  templateUrl: './women-collapse.component.html',
  styleUrls: ['./women-collapse.component.scss']
})
export class WomenCollapseComponent implements OnInit {
