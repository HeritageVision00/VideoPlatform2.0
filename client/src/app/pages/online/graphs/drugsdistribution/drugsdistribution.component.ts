...
@Component({
  selector: 'ngx-drugsdistribution',
  templateUrl: './drugsdistribution.component.html',
  styleUrls: ['./drugsdistribution.component.scss']
})
export class DrugsdistributionComponent implements OnInit {
