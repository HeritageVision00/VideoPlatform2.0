...
@Component({
  selector: 'ngx-scene-change',
  templateUrl: './scene-change.component.html',
  styleUrls: ['./scene-change.component.scss']
})
export class SceneChangeComponent implements OnInit, OnDestroy {
  ...
  ngOnInit(): void {
    ...
    this.serv.sceneChange(this.camera, l).subscribe(
      (res) => {
        this.sceneChange = res["data"];
        for (var m of this.sceneChange.raw) {
          ...
          m["clip_path"] =
            ...
            "/" +
            m["clip_path"];
            m['videoClip']  = this.sanitizer.bypassSecurityTrustUrl(api + '/pictures/' + this.now_user['id_account'] + '/' + m['id_branch'] + '/sceneChange/' + m['cam_id'] + '/' + m['movie']);
            ...
            datasets: [
              {
                ...
                data: Object.values(this.sceneChange.over),
