...
@Component({
  selector: "ngx-waving-hands",
  templateUrl: "./waving-hands.component.html",
  styleUrls: ["./waving-hands.component.scss"],
})
export class WavingHandsComponent implements OnInit, OnDestroy {
  ...
  ngOnInit(): void {
    ...
    this.serv.wavingHands(this.camera, l).subscribe(
      (res) => {
        this.wavingHands = res["data"];
        for (var m of this.wavingHands.raw) {
          ...
          m['videoClip']  = this.sanitizer.bypassSecurityTrustUrl(api + '/pictures/' + this.now_user['id_account'] + '/' + m['id_branch'] + '/WavingHand/' + m['cam_id'] + '/' + m['movie']);
          m["clip_path"] =
            api +
            "/pictures/" +
            this.now_user["id_account"] +
            ...
            datasets: [
              {
                ...
                data: Object.values(this.wavingHands.over),
