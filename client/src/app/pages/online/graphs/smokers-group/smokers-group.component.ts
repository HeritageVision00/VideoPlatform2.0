...
@Component({
  selector: 'ngx-smokers-group',
  templateUrl: './smokers-group.component.html',
  styleUrls: ['./smokers-group.component.scss']
})
export class SmokersGroupComponent implements OnInit {
