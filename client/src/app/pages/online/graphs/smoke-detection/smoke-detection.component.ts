...
@Component({
  selector: 'ngx-smoke-detection',
  templateUrl: './smoke-detection.component.html',
  styleUrls: ['./smoke-detection.component.scss']
})
export class SmokeDetectionComponent implements OnInit, OnDestroy {
  ...
  ngOnInit(): void {
    ...
    this.serv.smokeDetection(this.camera, l).subscribe(
      (res) => {
        this.smokeDetection = res["data"];
        for (var m of this.smokeDetection.raw) {
            ...
            datasets: [
              {
                ...
                data: Object.values(this.smokeDetection.over),
