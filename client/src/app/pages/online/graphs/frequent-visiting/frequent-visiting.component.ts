...
@Component({
  selector: 'ngx-frequent-visiting',
  templateUrl: './frequent-visiting.component.html',
  styleUrls: ['./frequent-visiting.component.scss']
})
export class FrequentVisitingComponent implements OnInit {
