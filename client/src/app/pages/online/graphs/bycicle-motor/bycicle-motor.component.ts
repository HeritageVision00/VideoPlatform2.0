...
@Component({
  selector: 'ngx-bycicle-motor',
  templateUrl: './bycicle-motor.component.html',
  styleUrls: ['./bycicle-motor.component.scss']
})
export class BycicleMotorComponent implements OnInit  {
