...
@Component({
  selector: 'ngx-stalking-woman-night',
  templateUrl: './stalking-woman-night.component.html',
  styleUrls: ['./stalking-woman-night.component.scss']
})
export class StalkingWomanNightComponent implements OnInit {
