...
@Component({
  selector: 'ngx-edge-crossing',
  templateUrl: './edge-crossing.component.html',
  styleUrls: ['./edge-crossing.component.scss']
})
export class EdgeCrossingComponent  implements OnInit  {
