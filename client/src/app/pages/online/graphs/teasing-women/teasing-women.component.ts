...
@Component({
  selector: 'ngx-teasing-women',
  templateUrl: './teasing-women.component.html',
  styleUrls: ['./teasing-women.component.scss']
})
export class TeasingWomenComponent implements OnInit {
