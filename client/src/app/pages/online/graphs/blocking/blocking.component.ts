...
export class BlockingComponent implements OnInit, OnDestroy {
  ...
  ngOnInit(): void {
    ...
    this.serv.blocking(this.camera, l).subscribe(
      (res) => {
        this.blocking = res["data"];
        for (var m of this.blocking.raw) {
        ...
        // this.source = this.blocking.raw
        //   .slice()
        //   .sort((a, b) => +new Date(b.time) - +new Date(a.time));
        let labels = [];
        for (var o of Object.keys(this.blocking.over)) {
          o = o + ":00:00";
            ...
            datasets: [
              {
                ...
                data: Object.values(this.blocking.over),
