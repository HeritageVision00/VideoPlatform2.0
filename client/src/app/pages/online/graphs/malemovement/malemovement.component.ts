...
@Component({
  selector: 'ngx-malemovement',
  templateUrl: './malemovement.component.html',
  styleUrls: ['./malemovement.component.scss']
})
export class MalemovementComponent implements OnInit {
