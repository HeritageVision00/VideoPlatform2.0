...
@Component({
  ...
  templateUrl: './transpassing.component.html',
  styleUrls: ['./transpassing.component.scss']
})
export class TranspassingComponent implements OnInit, OnDestroy {
  ...
  ngOnInit(): void {
    ...
    this.serv.transpassing(this.camera, l).subscribe(
      (res) => {
        this.transpassing = res["data"];
        for (var m of this.transpassing.raw) {
          ...
          m["clip_path"] =
            ...
            "/" +
            m["clip_path"];
            m['videoClip']  = this.sanitizer.bypassSecurityTrustUrl(api + '/pictures/' + this.now_user['id_account'] + '/' + m['id_branch'] + '/transpassing/' + m['cam_id'] + '/' + m['movie']);
            ...
            datasets: [
              {
                ...
                data: Object.values(this.transpassing.over),
