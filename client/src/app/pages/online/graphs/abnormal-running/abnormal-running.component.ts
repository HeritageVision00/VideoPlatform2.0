...
@Component({
  selector: 'ngx-abnormal-running',
  templateUrl: './abnormal-running.component.html',
  styleUrls: ['./abnormal-running.component.scss']
})
export class AbnormalRunningComponent implements OnInit {
