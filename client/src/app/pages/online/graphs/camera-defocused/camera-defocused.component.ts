...
@Component({
  selector: 'ngx-camera-defocused',
  templateUrl: './camera-defocused.component.html',
  styleUrls: ['./camera-defocused.component.scss']
})
export class CameraDefocusedComponent implements OnInit, OnDestroy {
  ...
  ngOnInit(): void {
    ...
    this.serv.cameraDefocused(this.camera, l).subscribe(
      (res) => {
        this.cameraDefocused = res["data"];
        for (var m of this.cameraDefocused.raw) {
        ...
        this.source = this.cameraDefocused.raw.slice().sort((a, b) => +new Date(b.time) - +new Date(a.time));
        let labels = [];
        for (var o of Object.keys(this.cameraDefocused.over)) {
          o = o + ":00:00";
          // labels.push(o)
            ...
            datasets: [
              {
                ...
                data: Object.values(this.cameraDefocused.over),
