...
@Component({
  selector: 'ngx-drinkers-group',
  templateUrl: './drinkers-group.component.html',
  styleUrls: ['./drinkers-group.component.scss']
})
export class DrinkersGroupComponent implements OnInit {
