...
@Component({
  selector: "ngx-disrobing",
  templateUrl: "./disrobing.component.html",
  styleUrls: ["./disrobing.component.scss"],
})
export class DisrobingComponent implements OnInit, OnDestroy {
  ...
  ngOnInit(): void {
    ...
    this.serv.disrobing(this.camera, l).subscribe(
      (res) => {
        this.disrobing = res["data"];
        for (var m of this.disrobing.raw) {
        ...
        this.source = this.disrobing.raw
          .slice()
          .sort((a, b) => +new Date(b.time) - +new Date(a.time));
        let labels = [];
        for (var o of Object.keys(this.disrobing.ress)) {
          o = o + ":00:00";
            ...
            datasets: [
              {
                ...
                data: Object.values(this.disrobing.ress),
