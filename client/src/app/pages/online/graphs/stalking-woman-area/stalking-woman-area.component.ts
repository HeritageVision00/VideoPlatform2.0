...
@Component({
  selector: 'ngx-stalking-woman-area',
  templateUrl: './stalking-woman-area.component.html',
  styleUrls: ['./stalking-woman-area.component.scss']
})
export class StalkingWomanAreaComponent implements OnInit {
