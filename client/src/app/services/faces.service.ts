...
export class FacesService {
  ...
  deleteUser(uuid: string, name:string) {
    return this.http.delete(`${this.API_URI}/fr/delete/${uuid}/${name}`);
  }
  ...
  getCamerasAll() {
    return this.http.get(`${this.API_URI}/camera/viewEver`);
  }
  getLiveCameras() {
    return this.http.get(`${this.API_URI}/camera/viewLiveCams`);
  }
  getLiveMics() {
    return this.http.get(`${this.API_URI}/mic/viewLiveCams`);
  }
  ...
  deleteMic(id: string) {
    return this.http.delete(`${this.API_URI}/mic/delete/${id}`);
  }
  saveCamera(camera: Camera) {
    return this.http.post(`${this.API_URI}/camera`, camera);
  }
  saveMic(mic: Microphone) {
    return this.http.post(`${this.API_URI}/mic`, mic);
  }
  ...
  setMenu(){
    return this.http.get(`${this.API_URI}/relations/menu`);
  }
  ...
  saveSchedule(day: Day) {
    return this.http.post(`${this.API_URI}/schedule/create`, day);
  }
  updateSchedule(day: Day) {
    return this.http.put(`${this.API_URI}/schedule/edit/${day.user_id}`, day);
  }
  getSchedule(day: Day) {
  ...
  deleteSchedule(user_id: number) {
    return this.http.delete(`${this.API_URI}/schedule/del/${user_id}`);
  }
  ...
  cameraStop() {
    const body = {}
    return this.http.post(`${this.API_URI}/camera/killStream`, body);
  }
  checkRel(id) {
  ...
  searchElastIncident(params: any) {
    return this.http.post(`${this.API_URI}/elastic/search1/`, params);
  }
  getImagesElast() {
  ...
  videoLink(body){
    return this.http.post(`${this.API_URI}/elastic/video/link`, body);
  }
  playCamera(body){
    return this.http.post(`${this.API_URI}/camera/liveFeed`, body);
  }  
  summarize(id){
    return this.http.get(`${this.API_URI}/summarization/${id}`);
  }  
  summarizeMultiple(body){
    return this.http.post(`${this.API_URI}/summarization`, body);
  }  
  back(body,id){
    return this.http.post(`${this.API_URI}/summarization/analyticsData/${id}`, body);
  }
  summOverlay(cam_id:string){
    return this.http.get(`${this.API_URI}/sum/${cam_id}`);
  }
  gpt(body){
    return this.http.post(`${this.API_URI}/sum2/gpt`,body);
  }
  batchVideos(id){
    return this.http.get(`${this.API_URI}/elastic/videosView/${id}`,);
  }
  sendNewInfo(body, id){
    return this.http.post(`${this.API_URI}/elastic/videosUpdateData/${id}`, body);
  }
  nextivaCams(){
    return this.http.get(`${this.API_URI}/vms/nextiva/getCams`);
  }
  nextivaRecording(body){
    return this.http.post(`${this.API_URI}/vms/nextiva/recording`, body);
  }
  deletePairOfVideos(body){
    return this.http.post(`${this.API_URI}/elastic/delPair`, body);
  }
}
