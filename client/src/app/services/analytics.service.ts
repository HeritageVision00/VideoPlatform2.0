...
export class AnalyticsService {
  ...
  climbingBarricade(id: string, dates){
    return this.http.post(`${this.API_URL}1/${id}`, dates);
  }
  ...
  peopleTracking(id: string, dates){
    return this.http.post(`${this.API_URL}51/${id}`, dates);
  }
  graffiti(id: string, dates){
    return this.http.post(`${this.API_URL}9/${id}`, dates);
  }
  am(id: string, dates){
    return this.http.post(`${this.API_URL}18/${id}`, dates);
  }
  uniformtracking(id: string, dates){
    return this.http.post(`${this.API_URL}110/${id}`, dates);
  }
  75(id: string, dates){
    return this.http.post(`${this.API_URL}75/${id}`, dates);
  }
  FlashingNudity(id: string, dates){
    return this.http.post(`${this.API_URL}76/${id}`, dates);
  }
  77(id: string, dates){
    return this.http.post(`${this.API_URL}77/${id}`, dates);
  }
  78(id: string, dates){
    return this.http.post(`${this.API_URL}78/${id}`, dates);
  }
  79(id: string, dates){
    return this.http.post(`${this.API_URL}79/${id}`, dates);
  }
  compiledRequest(id: string, dates, algoId){
    return this.http.post(`${this.API_URL}${algoId}/${id}`, dates)
  }
