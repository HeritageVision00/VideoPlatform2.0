            ...
            function (err, result) {
              ...
              result.forEach(element => {
                ...
                if (element.track_id == undefined || element.track_id == null) {
                  ...
                  resp.pic_path = `${process.env.my_ip}:${process.env.PORTNODE}/api/pictures/${decoded.id_account}/${decoded.id_branch}/${imgFolders[alertType]}/${id}/${picture}`
                }
                if (rel != null) {
                  if (rel.atributes[0].time > 0) {
                    if (element.track_id == undefined || element.track_id == null) {
                      ...
                      resp.pic_path = `${process.env.my_ip}:${process.env.PORTNODE}/api/pictures/${decoded.id_account}/${decoded.id_branch}/loitering/${req.params.id}/${resp.clip_path}`
                    }
                  }
                }
